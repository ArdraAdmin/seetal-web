...
import { getSalesApprovals, resubmitApprovalOrder } from "@/lib/api";
...
export default function SalesApprovalEditPage() {
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Update discount or payable, then send the order back for admin approval."
        actions={
          <Link
            href={`/sales/approvals/${params.id}`}
